...
<head>
  ...
  <title>Website Pengaduan Sampah Kota Pontianak</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="masyarakat.php">
        ...
        <div class="sidebar-brand-text mx-3">PENGADUAN SAMPAH</div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-secondary topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h3 class="navbar-light">Website Pengaduan Sampah Kota Pontianak</h3>
          <div class="container-fluid">
    <br>
   
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="masyarakat.php">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?url=tentang-kami">Tentang Kami</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?url=lihat-petugas">Petugas</a>
        </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Website Pengaduan Sampah&copy2024</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->

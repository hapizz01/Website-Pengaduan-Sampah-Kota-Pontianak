...
<head>
  ...
  <title>Website Pengaduan Sampah Kota Pontianak - Login</title>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Website Pengaduan Sampah Kota Pontianak</h1>
                  </div>
                  <form class="user" method="post" action="proses-login.php">
                    ...
                    <a href="index2.php" class="btn btn btn-user btn-block">
